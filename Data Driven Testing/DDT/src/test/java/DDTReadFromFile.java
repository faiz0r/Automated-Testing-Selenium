...
public class DDTReadFromFile {
	...
	public void setUp() {
		...
		report = new ExtentReports("C:\\Users\\Faiza\\Desktop\\webpagetest\\DDT.html");
	...
	public void excelTest() throws IOException, InterruptedException {
		...
		FileInputStream file = new FileInputStream("C:\\Users\\Faiza\\Desktop\\webpageTest\\DemoSiteDDT.xlsx");
